...
/**
 * Loads asset bundles from <code>application.xml</code> descriptors.
 */
        ...
        try {
            ...
            for (URL webDescriptor : webDescriptors) {
                try {
                    ...
                    LOGGER.error("Failed to load web resources from web descriptors: " + webDescriptor.toExternalForm(), e);
                }
            }

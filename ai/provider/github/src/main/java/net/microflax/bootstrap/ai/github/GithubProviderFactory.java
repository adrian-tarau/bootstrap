...
public class GithubProviderFactory extends AbstractProviderFactory {
    ...
    public Provider createProvider() {
        net.microfalx.bootstrap.ai.api.Provider.Builder builder = new net.microfalx.bootstrap.ai.api.Provider.Builder("github");
    ...
    private void registerModels(net.microfalx.bootstrap.ai.api.Provider.Builder builder) {
        ...
        builder.model((Model.Builder) Model.create("O1", "o1")
                .maximumContextLength(128_000).tag("openai"));
        builder.model((Model.Builder) Model.create("O3", "o3")
                .maximumContextLength(128_000).tag("openai"));
        builder.model((Model.Builder) Model.create("O3 Mini", "o3-mini")
                .maximumContextLength(128_000).maximumContextLength(128_000).tag("openai").tag("mini"));
        builder.model((Model.Builder) Model.create("O4 Mini", "o4-mini")
                .maximumContextLength(128_000).tag("openai").tag("mini"));

        builder.model((Model.Builder) Model.create("Claude Opus 4", "Claude Opus 4")
                .maximumContextLength(200_000).tag("anthropic").tag("claude").tag("opus"));
        builder.model((Model.Builder) Model.create("Claude 3.5 Sonnet", "Claude 3.5 Sonnet")
                .maximumContextLength(200_000).tag("anthropic").tag("claude").tag("sonnet"));
        builder.model((Model.Builder) Model.create("Claude 3.7 Sonnet", "Claude 3.7 Sonnet")
                .maximumContextLength(200_000).tag("anthropic").tag("claude").tag("sonnet"));
        builder.model((Model.Builder) Model.create("Claude 3.7 Sonnet Thinking", "Claude 3.7 Sonnet Thinking")
                .maximumContextLength(200_000).tag("anthropic").tag("claude").tag("sonnet").tag("thinking"));
        builder.model((Model.Builder) Model.create("Claude Sonnet 4", "Claude Sonnet 4")
                .maximumContextLength(200_000).tag("anthropic").tag("claude").tag("sonnet"));
        builder.model((Model.Builder) Model.create("Gemini 2.0 Flash", "Gemini 2.0 Flash")
                .maximumContextLength(1_000_000).tag("google").tag("gemini").tag("flash"));
